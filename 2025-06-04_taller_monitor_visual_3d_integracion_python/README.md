...
![Cambio de tamaño según dedos](https://github.com/JuanDanielRamirezMojica/computacion-visual/blob/main/2025-06-04_taller_monitor_visual_3d_integracion_python/resultados/GifUnity.gif?raw=true)
...
Integración Python–Unity, comunicación por JSON y lógica visual. conexión YOLO/MediaPipe. diseño visual y validación de sincronización. creación de README y documentación en GitLab.
